...
<div class="pageHeader">
    <form onsubmit="return navTabSearch(this);" action="view/app/list" method="post" class="pageForm required-validate">
      <div class="searchBar">
      <table class="searchContent">
        <tr>
            <td>
                        应用名称：<input type="text" name=name value="${param.name}"/> 
            </td>
        </tr>
      </table>
      <div class="subBar">
...
<div class="pageContent">
        <div class="panelBar">
            <ul class="toolBar">
                <li><a class="add" href="view/app/goadd" rel="lookup2organization" target="dialog" width="500" height="370" mask="true" close="closedialog"><span>添加</span></a></li>
                <li><a class="delete" href="view/app/del?id={sid}" target="ajaxTodo" title="确定删除该应用吗?"><span>删除</span></a></li>
                <li><a class="edit" href="view/app/detail?id={sid}" rel="lookup2organization" target="dialog" width="500" height="370" mask="true" close="closedialog"><span>修改</span></a></li>         
            </ul>
        </div>
